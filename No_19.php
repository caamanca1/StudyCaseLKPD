...
<body>
  <form method="post" action="#">
    <table>
      ...
      <tr>
        ...
        <select id="cars" name="kategori_tiket">
  ...
  if (isset($_POST['submit'])) {
    ...
    print("Total Tiket : " . $total_tiket . "<br>Keuntungan Vip : " . $keuntungan_vip . "<br>Keuntungan Eksekutif : " . $keuntungan_eksekutif . "<br>Keuntungan Ekonomi : " . $keuntungan_ekonomi);
    print("<br>Keuntungan Keseluruhan : " . $keuntungan_keseluruhan);
    // print($vip . $eksekutif . $keuntungan_keseluruhan);
  }
  ?>
